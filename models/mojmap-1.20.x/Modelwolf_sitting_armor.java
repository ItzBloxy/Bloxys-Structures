...
public class Modelwolf_sitting_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "wolf_sitting_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -3.0F, -2.5F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.25F)).texOffs(16, 14)
						.addBox(2.0F, -5.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(16, 14)
						.addBox(-2.0F, -5.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(0, 10)
						.addBox(-0.5F, -0.02F, -5.5F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition leg2_r1 = bone2.addOrReplaceChild("leg2_r1",
				CubeListBuilder.create().texOffs(0, 18)
						.addBox(0.5F, -8.0F, 6.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.25F)).texOffs(0, 18)
						.addBox(-2.5F, -8.0F, 6.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.5708F, 0.0F, 0.0F));

		PartDefinition leg4 = partdefinition.addOrReplaceChild("leg4",
				CubeListBuilder.create().texOffs(0, 18)
						.addBox(0.0F, 0.5F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.25F)).texOffs(0, 18)
						.addBox(-3.0F, 0.5F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.25F)),
