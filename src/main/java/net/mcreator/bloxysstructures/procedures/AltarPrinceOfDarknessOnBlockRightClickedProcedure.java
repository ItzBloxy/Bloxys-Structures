...
public class AltarPrinceOfDarknessOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		BloxysstructuresMod.queueServerWork(20, () -> {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = BloxysstructuresModEntities.PRINCE_OF_DARKNESS.get().spawn(_level, BlockPos.containing(x, y + 1, z), MobSpawnType.MOB_SUMMONED);
