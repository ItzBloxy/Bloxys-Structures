...
public class BloxysScytheThrowablePlayerRenderer extends EntityRenderer<BloxysScytheThrowablePlayerEntity> {
	...
	public BloxysScytheThrowablePlayerRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelthrowablescythe6(context.bakeLayer(Modelthrowablescythe6.LAYER_LOCATION));
	}

	@Override
	public void render(BloxysScytheThrowablePlayerEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(BloxysScytheThrowablePlayerEntity entity) {
		return texture;
	}
}
