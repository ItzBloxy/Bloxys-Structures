...
public class Modelquantumorb4<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("bloxysstructures", "modelquantumorb_4"), "main");
	public final ModelPart orbs;

	public Modelquantumorb4(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = orbs.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(112, 14).mirror().addBox(-2.0F, -3.0F, -15.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.125F)).mirror(false).texOffs(112, 0).mirror()
		...
		PartDefinition cube_r2 = orbs.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(112, 0).mirror().addBox(-2.0F, -3.0F, -15.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(112, 14).mirror()
		...
		PartDefinition cube_r4 = orbs.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(112, 14).mirror().addBox(-2.0F, -3.0F, -15.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.125F)).mirror(false).texOffs(112, 0).mirror()
				.addBox(-2.0F, -3.0F, -15.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
