...
public class Modeltreemoo<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("bloxysstructures", "modeltreemoo"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(22, 0).addBox(-5.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-4.0F, -4.0F, -6.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 96)
						.addBox(-4.0F, -4.0F, -6.0F, 8.0F, 8.0F, 6.0F, new CubeDeformation(0.15F)).texOffs(20, 0).addBox(4.0F, -5.0F, -4.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 4.0F, -8.0F));
		PartDefinition mushroom1 = head.addOrReplaceChild("mushroom1",
				CubeListBuilder.create().texOffs(0, 32).addBox(-8.0F, -12.0F, 0.0F, 16.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(0.0F, -11.0F, -8.0F, 0.0F, 11.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.0F, -3.2F, 0.0F, -0.576F, 0.0F));
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(18, 4).addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(18, 100)
				.addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, new CubeDeformation(0.15F)).texOffs(52, 0).addBox(-2.0F, 2.0F, -8.0F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 5.0F, 2.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition mushroom2 = mushrooms.addOrReplaceChild("mushroom2",
				CubeListBuilder.create().texOffs(0, 32).addBox(-7.3707F, -12.0F, -0.7771F, 16.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(0.6293F, -11.0F, -8.7771F, 0.0F, 11.0F, 16.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition mushroom3 = mushrooms.addOrReplaceChild("mushroom3",
				CubeListBuilder.create().texOffs(0, 33).addBox(-8.0F, -11.0F, 0.0F, 16.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 16).addBox(0.0F, -12.0F, -8.0F, 0.0F, 12.0F, 16.0F, new CubeDeformation(0.0F)),
