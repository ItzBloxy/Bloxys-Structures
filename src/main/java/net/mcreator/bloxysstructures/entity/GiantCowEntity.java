...
import net.mcreator.bloxysstructures.procedures.GiantCowEntityDiesProcedure;
import net.mcreator.bloxysstructures.init.BloxysstructuresModEntities;

public class GiantCowEntity extends Animal {
	public GiantCowEntity(EntityType<GiantCowEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
		refreshDimensions();
	...
	public void die(DamageSource source) {
		super.die(source);
		GiantCowEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GiantCowEntity retval = BloxysstructuresModEntities.GIANT_COW.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(BloxysstructuresModEntities.GIANT_COW.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
