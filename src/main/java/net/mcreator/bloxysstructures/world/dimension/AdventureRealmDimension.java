...
package net.mcreator.bloxysstructures.world.dimension;
...
public class AdventureRealmDimension {
	@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
	public static class AdventureRealmSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("bloxysstructures:adventure_realm"), customEffect);
		}
	}
}
