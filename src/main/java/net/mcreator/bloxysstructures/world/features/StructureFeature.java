package net.mcreator.bloxysstructures.world.features;
...
import net.mcreator.bloxysstructures.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, BloxysstructuresMod.MODID);
